...
- Split the dairoot Grok mirror into its own built-in `Grok Mirror` Summary config with a mirror-specific Copy-button userscript, while refreshing the official Grok config to remove mirror hosts; Summary site config is now v36.
